...
import { Sparkles, AlertTriangle, ShieldCheck, Stethoscope, ArrowRight, Printer, Clock, Calendar, User, Heart, FileText, Pill, X } from 'lucide-react';
...
export default function AISuggestionBox({ analysis, patientName, doctorName, slotInfo, vitals, onClose }: AISuggestionBoxProps) {
        ...
        <div className="bg-blue-600 px-6 py-3 flex items-center justify-between print:hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            {onClose && (
              <button 
                onClick={onClose}
                className="p-1 hover:bg-white/20 rounded-full transition-colors text-white ml-2"
                aria-label="Close"
              >
                <X className="w-5 h-5" />
              </button>
